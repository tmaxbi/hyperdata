...
cp -r /db/tb/src/client /db/
cp /db/tb/src/tibero/license.xml $TB_HOME/license/license.xml
cp /db/tb/src/tibero/tbdsn.tbr $TB_HOME/client/config/
cp /db/tb/src/tibero/*.tip $TB_HOME/config/
